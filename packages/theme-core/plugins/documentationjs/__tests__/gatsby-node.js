...
describe(`transformer-react-doc-gen: onCreateNode`, () => {
  ...
  describe(`Simple example`, () => {
    ...
    it(`should extract out a description, params, and examples`, () => {
      ...
      expect(appleNode.examples).toHaveLength(1);
    ...
    it(`doesn't create multiple nodes with same id`, () => {
      ...
      Object.keys(groupedById).forEach(id =>
        expect(groupedById[id]).toHaveLength(1),
      );
    });
  });
  ...
  describe(`Complex example`, () => {
    ...
    describe(`should handle typedefs`, () => {
      ...
      it(`should have property nodes for typedef`, () => {
        ...
        expect(typedefNode.properties___NODE).toHaveLength(2);
      ...
      it(`should have second param as nested object`, () => {
        ...
        expect(nestedNode.properties___NODE).toHaveLength(3);
        [
          nestedFooNode,
          nestedOptionalNode,
          nestedCallbackNode,
    ...
    describe(`should handle members`, () => {
      ...
      it(`should have link from complex node to its members`, () => {
        ...
        expect(complexNode.members.static___NODE).toHaveLength(1);
  ...
  describe(`JSDoc + Flow`, () => {
    ...
    it(`merges JsDoc and flow types`, () => {
      ...
      expect(firstParamNodes).toHaveLength(1);
      expect(firstParamNodes[0].properties___NODE).toHaveLength(1);
